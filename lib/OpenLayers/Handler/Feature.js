...
//原始：var click = (type == "click" || type == "dblclick" || type == "touchstart");
        ...
        if(this.feature) {
            ...
            if(this.geometryTypeMatches(this.feature)) {
                ...
                if(previouslyIn && inNew) {
                    ...
                    if(this.lastFeature) {
                        //原始：this.triggerCallback(type, 'out', [this.lastFeature]);
                    	this.triggerCallback(type, 'out', [this.lastFeature,type]);
                    }
