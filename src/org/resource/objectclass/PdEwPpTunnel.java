...
/**
 * PdEwPpTunnel generated by hbm2java
 */
public class PdEwPpTunnel implements java.io.Serializable {
	...
	private Integer bearingStructure;
	private Integer suspensionMode;
	...
	public PdEwPpTunnel(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpTunnel(int autoId, Long staticId, String name,
			...
			Integer attachmentId, Integer bearingStructure,
			Integer suspensionMode, String sectionType, String sectionSize,
			Integer length, Double buriedDepth, String suspensionParts) {
		this.autoId = autoId;
		...
		this.bearingStructure = bearingStructure;
...
//		this.completionDate = completionDate;
	...
	public Integer getBearingStructure() {
		return this.bearingStructure;
	}

	public void setBearingStructure(Integer bearingStructure) {
		this.bearingStructure = bearingStructure;
	}
	...
	public void setSuspensionMode(Integer suspensionMode) {
		this.suspensionMode = suspensionMode;
	}
	...
	public void setSuspensionParts(String suspensionParts) {
		this.suspensionParts = suspensionParts;
	}
