...
/**
 * PdEwPpCablePipeV generated by hbm2java
 */
public class PdEwPpCablePipeV implements java.io.Serializable {
	...
	public PdEwPpCablePipeV() {
	}

	public PdEwPpCablePipeV(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpCablePipeV(int autoId, Long staticId, String name,
