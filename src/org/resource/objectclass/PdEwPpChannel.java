...
/**
 * PdEwPpChannel generated by hbm2java
 */
public class PdEwPpChannel implements java.io.Serializable {
	...
	public PdEwPpChannel() {
	}

	public PdEwPpChannel(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpChannel(int autoId, Long staticId, String name,
			...
			Integer attachmentId, String sectionSize, Double lenght,
			Double buriedDepth, Integer material, String suspensionParts) {
		this.autoId = autoId;
