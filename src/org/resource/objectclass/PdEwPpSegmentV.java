...
/**
 * PdEwPpSegmentV generated by hbm2java
 */
public class PdEwPpSegmentV implements java.io.Serializable {
	...
	public PdEwPpSegmentV() {
	}

	public PdEwPpSegmentV(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpSegmentV(int autoId, Long staticId, String name,
