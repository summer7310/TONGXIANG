...
/**
 * PdEwPpJacking generated by hbm2java
 */
public class PdEwPpJacking implements java.io.Serializable {
	...
	public PdEwPpJacking() {
	}

	public PdEwPpJacking(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpJacking(int autoId, Long staticId, String name,
			...
			Integer attachmentId, String sectinType, Integer material1,
			Integer material2, Integer pipeDiameter, Integer pipeDiameter2,
			Integer length, Integer cableConduit, Double buriedDepth,
...
//		this.completionDate = completionDate;
	...
	public String getSectinType() {
		return this.sectinType;
	}

	public void setSectinType(String sectinType) {
		this.sectinType = sectinType;
	}
