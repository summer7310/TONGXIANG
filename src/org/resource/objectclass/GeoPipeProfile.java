...
/**
 * pipeProfile generated by hbm2java
 */
public class GeoPipeProfile implements java.io.Serializable {
	...
	public GeoPipeProfile() {
	}

	public GeoPipeProfile(int autoId) {
		this.autoId = autoId;
	}

	public GeoPipeProfile(int autoId, Geometry geometryData, Long staticId,
			String name, Integer objectType, Integer rfid, Integer isbn,
			Long wellId, Long profileId,Long ppSegmentId) {
		this.autoId = autoId;
