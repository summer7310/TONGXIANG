...
/**
 * PdElCnSwitchStation generated by hbm2java
 */
public class PdElCnSwitchStation implements java.io.Serializable {
	...
	private Integer circuitCountIn;
	private Integer circuitCountOut;
	private Integer backupCompartmentCount;
	private Boolean lowPressureOut;
	private Double reactiveCompensation;
	private Integer antiErrorMethod;
	private Boolean independentStructure;

	public PdElCnSwitchStation() {
	}

	public PdElCnSwitchStation(int autoId) {
		this.autoId = autoId;
	}

	public PdElCnSwitchStation(int autoId, Long staticId, String name,
			...
			String assetCode, Integer circuitCountIn, Integer circuitCountOut,
			Integer backupCompartmentCount, Boolean lowPressureOut,
			Double reactiveCompensation, Integer antiErrorMethod,
			Boolean independentStructure) {
		this.autoId = autoId;
		...
		this.circuitCountIn = circuitCountIn;
		this.circuitCountOut = circuitCountOut;
		this.backupCompartmentCount = backupCompartmentCount;
		this.lowPressureOut = lowPressureOut;
		this.reactiveCompensation = reactiveCompensation;
		this.antiErrorMethod = antiErrorMethod;
...
//		this.commissioningDate = commissioningDate;
	...
	public Integer getCircuitCountIn() {
		return this.circuitCountIn;
	}

	public void setCircuitCountIn(Integer circuitCountIn) {
		this.circuitCountIn = circuitCountIn;
	}
	...
	public Boolean getLowPressureOut() {
		return this.lowPressureOut;
	}

	public void setLowPressureOut(Boolean lowPressureOut) {
		this.lowPressureOut = lowPressureOut;
	}

	public Double getReactiveCompensation() {
		return this.reactiveCompensation;
	}

	public void setReactiveCompensation(Double reactiveCompensation) {
		this.reactiveCompensation = reactiveCompensation;
	}

	public Integer getAntiErrorMethod() {
		return this.antiErrorMethod;
	}

	public void setAntiErrorMethod(Integer antiErrorMethod) {
		this.antiErrorMethod = antiErrorMethod;
	}

	public Boolean getIndependentStructure() {
		return this.independentStructure;
	}

	public void setIndependentStructure(Boolean independentStructure) {
		this.independentStructure = independentStructure;
	}
