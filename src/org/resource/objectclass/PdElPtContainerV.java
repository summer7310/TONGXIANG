...
/**
 * PdElPtContainerV generated by hbm2java
 */
public class PdElPtContainerV implements java.io.Serializable {
	...
	public PdElPtContainerV() {
	}

	public PdElPtContainerV(int autoId) {
		this.autoId = autoId;
	}

	public PdElPtContainerV(int autoId, Long staticId, String name,
