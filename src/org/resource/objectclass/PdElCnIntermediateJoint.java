...
public class PdElCnIntermediateJoint {
	private int autoId;
	...
	private Integer elHostType;
	private Long elHostId;
	//private Integer ewHostType;
	//private Long ewHostId;
	private String jointTemp;
	private Integer voltageGrade;
	private Integer jointType;
	private Integer attachmentStructure;
	private String intermediateJointModel;
	private String manufacturer;
	private String builder;
	public PdElCnIntermediateJoint(){	
	}
	public PdElCnIntermediateJoint(int autoId){
		this.autoId = autoId;
	}
	public PdElCnIntermediateJoint(int autoId, Long staticId, String name,
			...
			Integer elHostType, Long elHostId, 
			String jointTemp, Integer voltageGrade,
			Integer jointType, Integer attachmentStructure,
			String intermediateJointModel, String manufacturer, String builder) {
		this.autoId = autoId;
		...
		this.elHostType = elHostType;
		this.elHostId = elHostId;
		//this.ewHostType = ewHostType;
		//this.ewHostId = ewHostId;
		this.jointTemp = jointTemp;
		this.voltageGrade = voltageGrade;
		this.jointType = jointType;
		this.attachmentStructure = attachmentStructure;
		this.intermediateJointModel = intermediateJointModel;
	...
	public Integer getElHostType() {
		return elHostType;
	}
	public void setElHostType(Integer elHostType) {
		this.elHostType = elHostType;
	}
	public Long getElHostId() {
		return elHostId;
	}
	public void setElHostId(Long elHostId) {
		this.elHostId = elHostId;
	}
//	public Integer getEwHostType() {
//		return ewHostType;
//	}
//	public void setEwHostType(Integer ewHostType) {
//		this.ewHostType = ewHostType;
//	}
//	public Long getEwHostId() {
//		return ewHostId;
//	}
//	public void setEwHostId(Long ewHostId) {
//		this.ewHostId = ewHostId;
//	}
	public String getJointTemp() {
		return jointTemp;
	}
	public void setJointTemp(String jointTemp) {
		this.jointTemp = jointTemp;
	}
	...
	public Integer getAttachmentStructure() {
		return attachmentStructure;
	}
	public void setAttachmentStructure(Integer attachmentStructure) {
		this.attachmentStructure = attachmentStructure;
	}
	public String getIntermediateJointModel() {
		return intermediateJointModel;
	}
	public void setIntermediateJointModel(String intermediateJointModel) {
		this.intermediateJointModel = intermediateJointModel;
	}
