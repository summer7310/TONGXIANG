...
/**
 * PipeHole generated by hbm2java
 */
public class GeoPipeHole implements java.io.Serializable {
	...
	public GeoPipeHole(int autoId) {
		this.autoId = autoId;
	}

	public GeoPipeHole(int autoId, Geometry geometryData, Long staticId,
			String name, Integer objectType, Integer rfid, Integer isbn,
			Long wellId,Long ppSegmentId) {
		this.autoId = autoId;
