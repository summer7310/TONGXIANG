...
/**
 * PdElCnSwitch generated by hbm2java
 */
public class PdElCnSwitch implements java.io.Serializable {
	...
	public PdElCnSwitch(int autoId) {
		this.autoId = autoId;
	}

	public PdElCnSwitch(int autoId, Long staticId, String name,
			...
			String assetCode, String manufacturer, String model,
			Integer voltageGrade, Long belongsTower, String manufactureCode,
			Date manufactureDate, Double ratedVoltage, Double ratedCurrent) {
		this.autoId = autoId;
		...
		this.belongsTower = belongsTower;
...
//		this.commissioningDate = commissioningDate;
	...
	public Long getBelongsTower() {
		return this.belongsTower;
	}

	public void setBelongsTower(Long belongsTower) {
		this.belongsTower = belongsTower;
	}
