...
/**
 * PdEwPpBridge generated by hbm2java
 */
public class PdEwPpBridge implements java.io.Serializable {
	...
	public PdEwPpBridge(int autoId) {
		this.autoId = autoId;
	}

	public PdEwPpBridge(int autoId, Long staticId, String name,
			...
			Integer pipeDiameter, String length, Integer cableConduit,
