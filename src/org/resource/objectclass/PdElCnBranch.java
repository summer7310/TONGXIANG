...
/**
 * PdElCnBranch generated by hbm2java
 */
public class PdElCnBranch implements java.io.Serializable {
	...
	public PdElCnBranch(int autoId) {
		this.autoId = autoId;
	}

	public PdElCnBranch(int autoId, Long staticId, String name,
