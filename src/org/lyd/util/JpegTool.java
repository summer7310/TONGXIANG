...
public class JpegTool { 
        ...
        private File pic_big_pathfilename; //定义源图片所在的带路径目录的文件名
        private File pic_small_pathfilename; // 生成小图片的带存放路径目录的文件名 
        ...
        */ 
         ...
         *返回大图片路径 
         */
        public File getpic_big_pathfilename()
        {
         ...
         * 返回小图片路径
         */
        public File getpic_small_pathfilename()
        {
        ...
        * @throws JpegToolException 
        */ 
        public void doFinal(File pic_big_pathfilename,File pic_small_pathfilename) throws JpegToolException { 
                if(!this.isInitFlag){ 
                ...
                if((!pic_big_pathfilename.getName().toLowerCase().endsWith("jpg")) && (!pic_big_pathfilename.getName().toLowerCase().endsWith("jpeg"))){ 
                    throw new JpegToolException(" 只能处理 JPG/JPEG 文件！ "); 
                } 
                if((!pic_small_pathfilename.getName().toLowerCase().endsWith("jpg")) && !pic_small_pathfilename.getName().toLowerCase().endsWith("jpeg")){ 
                    throw new JpegToolException(" 只能处理 JPG/JPEG 文件！ "); 
                } 
                ...
                int smallh = 0; 
                // 新建源图片和生成的小图片的文件对象 
                File fi = pic_big_pathfilename; 
                File fo = pic_small_pathfilename; 
                //生成图像变换对象 
